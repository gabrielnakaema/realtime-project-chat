...
} from '@/features/tasks/hooks/task-comments-pagination';
import { useSocket } from '@/shared/hooks/use-socket';
import { createTaskComment, listTaskComments } from '@/features/tasks/services/tasks';
...
export const prependCommentToInfiniteData = (
  ...
  if (incoming.parent_comment_id) {
    ...
    const parentLoaded = allComments.some((c) => c.id === parentCommentId || commentExists(c.replies, parentCommentId));
